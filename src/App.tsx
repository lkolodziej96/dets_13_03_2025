      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-4">
            <img src="/image.png" alt="Belfer Center Logo" className="h-16" />
            {data.length > 0 && (
              <button
                onClick={handleReset}
          ...
          <div className="text-center">
            ...
            <h2 className="text-2xl mb-2">Defense, Emerging Technologies, and Strategy Project</h2>
            <h3 className="text-xl">Belfer Center for Science and International Affairs</h3>
          </div>
        </div>
      </div>
      ...
      {data.length === 0 ? (
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-2">Only .xlsx or .xls files are accepted</p>
          </div>
        </div>
      ) : (
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex gap-6">
            ...
            <div className="w-80 flex-shrink-0">
              <div className="bg-white rounded-lg shadow-sm p-6 sticky top-6">
                ...
                <SectorWeights weights={sectorWeights} onChange={handleSectorWeightChange} />
              </div>
            </div>
              ...
              <div className="grid grid-cols-5 gap-6">
                ...
                <div className="col-span-2 bg-white rounded-lg shadow-sm p-6 overflow-hidden">
                  ...
                  <div className="relative" style={{ height: '400px' }}>
                    <PieChart
                      data={
                        selectedCountry ? data.filter((d) => d.country === selectedCountry) : data
                      }
                      selectedSector={selectedSector}
